Algoritmo cuestion2
	...
	Escribir ""
	//comprueba si es menor a < b y en caso afirmativo lee lo que esta dentro, sino escribe es mayor
	Si a < b Entonces
		Escribir "patata"
	SiNo
		Escribir "Es mayor ", a
		Si b < c Entonces //vuelve a realizar otro if donde compruebe si b < c
			Escribir "Es menor que ", c
		FinSi
	Fin Si
	...
	Leer val
	Segun val Hacer //dependiendo del valor de val realiza: 
		1: //si val es 1 
	...
	//cada vez que se repite el bucle aumenta en 1, que es lo definido por defecto
	...
	Escribir "Escribimos 5 veces la palabra patata"
	cont <- 0
	//este bucle repite infinitamente hasta que, en este caso, cont no sea igual a 5
	//para que podamos salir del bucle usamos un contador que aumentara en 1 cada vez que repite el bucle
